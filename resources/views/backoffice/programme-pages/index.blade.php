        ...
        <div class="board-filter">
            <form method="GET" action="{{ route($context['route'].'.index') }}" class="filter-form" id="searchForm">
                ...
                <div class="filter-row">
                    ...
                    <div class="filter-group"><div class="filter-buttons"><button type="submit" class="btn btn-primary"><i class="fas fa-search"></i> 검색</button><a href="{{ route($context['route'].'.index') }}" class="btn btn-secondary"><i class="fas fa-undo"></i> 초기화</a></div></div>
                </div>
            </form>
        </div>
