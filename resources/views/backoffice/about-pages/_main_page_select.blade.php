<div class="bo-form-row">
    ...
    <div class="bo-form-field">
        ...
        <small class="bo-password-help">선택하면 해당 Main Page의 ABOUT 항목에 자동으로 연결됩니다.</small>
...
<div class="bo-form-row">
    ...
    <div class="bo-form-field">
        <input type="text" class="board-form-control @error('page_title') is-invalid @enderror" id="page_title" name="page_title" value="{{ old('page_title', $aboutPage?->page_title) }}" maxlength="255" required>
