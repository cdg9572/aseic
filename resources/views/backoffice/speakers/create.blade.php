...
<div class="board-container">
    ...
    <div class="board-card">
        <div class="board-card-body">
            <form action="{{ route('backoffice.speakers.store') }}" method="POST" enctype="multipart/form-data" id="speakerForm" class="bo-compact-form">
                @csrf
                @include('backoffice.speakers._form')
