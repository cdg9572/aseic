...
<head>
    ...
    <style>
    @font-face{font-family:'Pretendard';font-style:normal;font-weight:300 900;src:url('/css/font/PretendardVariable.woff2') format('woff2');font-display:swap;}
    body{font-family:'Pretendard','Dotum',Arial,sans-serif;}
    </style>

    <link rel="preload" href="/css/font/PretendardVariable.woff2" as="font" type="font/woff2" crossorigin>
    <link rel="icon" href="{{ asset('images/favicon.png') }}" type="image/png"/>

    {!! \App\Helpers\CssHelper::minTag('/css/default.css') !!}
    {!! \App\Helpers\CssHelper::minTag('/css/layout.css') !!}

    @if($currentGNum === 'main')
        {!! \App\Helpers\CssHelper::minTag('/css/main.css') !!}
    @elseif(isset($menus[$currentGNum]))
        {!! \App\Helpers\CssHelper::minTag('/css/' . $menus[$currentGNum]['path'] . '.css') !!}
		...
		<div class="inner">
			<div class="logo">
				<a href="{{ route('home') }}" class="flex flex-center">
					<img src="{{ asset($currentGNum === 'main' ? 'images/logo_main.svg' : 'images/logo.svg') }}" alt="" aria-hidden="true">
