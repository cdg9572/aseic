...
@include('publishing-original.components.main.main-visual')
@include('publishing-original.components.main.speaker-slider')

<section class="mcon main_programme">
	<div class="inner flex">
		<div class="mtit"><h2>PROGRAMME</h2><a href="/publishing-original/programme" class="btn_link btn_bg_gra">More Info</a></div>
		<ul class="timetable">
			<li>
...
<section class="mcon main_register">
	<div class="inner">
		<div class="flex">
			...
			<a href="/publishing-original/registration" class="btn_link btn_more">Register Now</a>
		</div>
	</div>
</section>
...
<section class="mcon main_board">
	<div class="flex inner">
		<div class="box">
			<div class="mtit"><h2>ANNOUNCEMENTS</h2><a href="/publishing-original/announcements" class="btn_link btn_bg_gra">More Info</a></div>
			<ul class="list">
				<li><a href="/publishing-original/announcements/view"><div class="tit">Event Information</div><div class="date">2026.07.13</div></a></li>
				<li><a href="/publishing-original/announcements/view"><div class="tit">frequently asked question(FAQ)</div><div class="date">2026.07.13</div></a></li>
				<li><a href="/publishing-original/announcements/view"><div class="tit">frequently asked question(FAQ)</div><div class="date">2026.07.13</div></a></li>
				<li><a href="/publishing-original/announcements/view"><div class="tit">Pre-registration information</div><div class="date">2026.07.13</div></a></li>
			</ul>
		</div>
		<div class="box">
			<div class="mtit"><h2>PAST FORUM VIDEO</h2><a href="/publishing-original/media/youtube" class="btn_link btn_bg_gra">More Info</a></div>
			<div class="video_box">
				<a href="https://www.youtube.com/shorts/CCpPwCRE-f4" target="_blank"><img src="/publishing-original-assets/images/img_sample_video.avif" alt="2025 글로벌 에코 이노베이션 포럼 영상"></a>
			</div>
		</div>
	</div>
</section>
...
@push('scripts')
<link rel="stylesheet" href="/publishing-original-assets/css/swiper.css" media="all">
<script src="/publishing-original-assets/js/swiper.js"></script>
@endpush
