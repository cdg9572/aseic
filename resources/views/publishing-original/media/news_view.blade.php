...
<div class="inner">
	<section class="board_view">
		<article>
			...
			<div class="cont">
				<div class="tac"><img src="/publishing-original-assets/images/img_sample_news_large.avif" alt="사진 설명"></div>
				<br/>
			...
			<ul class="img_area">
				<li><button type="button"><span class="imgfit"><img src="/publishing-original-assets/images/img_sample_news.avif" data-large-src="/publishing-original-assets/images/img_sample_news_large.avif" alt="Image Title1"></span></button></li>
				<li><button type="button"><span class="imgfit"><img src="/publishing-original-assets/images/img_sample_news.avif" data-large-src="/publishing-original-assets/images/img_sample_news_large.avif" alt="Image Title2"></span></button></li>
				<li><button type="button"><span class="imgfit"><img src="/publishing-original-assets/images/img_sample_news.avif" data-large-src="/publishing-original-assets/images/img_sample_news_large.avif" alt="Image Title3"></span></button></li>
			</ul>
		</article>
